...
st.sidebar.caption("💡 **Utilidade:** Monitora a variação térmica ambiente para orientar o operador sobre os ajustes de reatividade e correções de massa no cabeçote.")
